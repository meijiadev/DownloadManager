...
public class GSYVideoManager extends GSYVideoBaseManager {
    ...
    public static boolean backFromWindowFull(Context context) {
        ...
        if (oldF != null) {
            backFrom = true;
            hideNavKey(context);
            if (com.shuyu.gsyvideoplayer.GSYVideoManager.instance().lastListener() != null) {
                com.shuyu.gsyvideoplayer.GSYVideoManager.instance().lastListener().onBackFullscreen();
            }
        }
        return backFrom;
    }
    ...
    public static void releaseAllVideos() {
        if (com.shuyu.gsyvideoplayer.GSYVideoManager.instance().listener() != null) {
            com.shuyu.gsyvideoplayer.GSYVideoManager.instance().listener().onCompletion();
        }
    ...
    public static void onPause() {
        if (com.shuyu.gsyvideoplayer.GSYVideoManager.instance().listener() != null) {
            com.shuyu.gsyvideoplayer.GSYVideoManager.instance().listener().onVideoPause();
        }
    }
    ...
    public static void onResume() {
        if (com.shuyu.gsyvideoplayer.GSYVideoManager.instance().listener() != null) {
            com.shuyu.gsyvideoplayer.GSYVideoManager.instance().listener().onVideoResume();
        }
    }
    ...
    public static void onResume(boolean seek) {
        if (com.shuyu.gsyvideoplayer.GSYVideoManager.instance().listener() != null) {
            com.shuyu.gsyvideoplayer.GSYVideoManager.instance().listener().onVideoResume(seek);
        }
    }
